...
export const INITIAL_VEHICLE_CHECKINS: any[] = [
  {
    id: 'GATE-2026-101',
    registrationNumber: 'MH02CB8811',
    make: 'Maruti Suzuki',
    model: 'Swift VXi 2022',
    color: 'Arctic White',
    fuelLevel: 65,
    mileage: 38450,
    isCars24: true,
    cars24RefNo: 'C24-MUM-8811',
    customerName: 'Cars24 Hub - Andheri West',
    customerPhone: '+91 98200 44556',
    checkedInAt: '2026-07-28 09:15 AM',
    checkedInByName: 'Marcus Vance (Gate Manager)',
    checkInDriverName: 'Ramesh Kumar (Cars24 Logistics)',
    checkInDriverPhone: '+91 98200 11223',
    checkInPhotoWithDriverUrl: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&w=800&q=80',
    checkInNotes: 'Vehicle dropped by Cars24 driver Ramesh. Waiting for WSM preliminary inspection (PI) & estimate approval.',
    status: 'IDLE_AWAITING_PI',
  },
  {
    id: 'GATE-2026-102',
    registrationNumber: 'DL01AB4321',
    make: 'Hyundai',
    model: 'Creta 1.5 SX',
    color: 'Titan Grey',
    fuelLevel: 45,
    mileage: 42100,
    isCars24: true,
    cars24RefNo: 'C24-DEL-4321',
    customerName: 'Cars24 Fleet Yard - Okhla',
    customerPhone: '+91 98110 99887',
    checkedInAt: '2026-07-28 10:30 AM',
    checkedInByName: 'Vikram Mehta (Floor Manager)',
    checkInDriverName: 'Suresh Singh (Fleet Driver)',
    checkInDriverPhone: '+91 98110 22334',
    checkInPhotoWithDriverUrl: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=800&q=80',
    checkInNotes: 'Driver Suresh brought car for denting-painting estimate. Awaiting PI approval from Cars24 WSM team.',
    status: 'IDLE_AWAITING_PI',
  },
  {
    id: 'GATE-2026-103',
    ...
    checkedInAt: '2026-07-26 09:00 AM',
    checkedInByName: 'Marcus Vance',
    checkInDriverName: 'Vikram Sharma (Customer Driver)',
    checkInDriverPhone: '+91 98200 12345',
    checkInPhotoWithDriverUrl: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=800&q=80',
    checkInNotes: 'Customer dropped vehicle for 50,000 km periodic service & brake overhaul.',
    status: 'JOB_CARD_CREATED',
    jobCardId: 'JC-2026-101',
  },
  {
    id: 'GATE-2026-104',
    registrationNumber: 'MH01DE5678',
    make: 'Hyundai',
    model: 'Creta 1.6 CRDi',
    color: 'Phantom Black',
    fuelLevel: 40,
    mileage: 38000,
    isCars24: true,
    cars24RefNo: 'C24-MUM-5678',
    customerName: 'Cars24 Hub - Thane',
    customerPhone: '+91 98200 99887',
    checkedInAt: '2026-07-26 11:15 AM',
    checkedInByName: 'Marcus Vance',
    checkInDriverName: 'Sunil Cars24 Logistics',
    checkInDriverPhone: '+91 98440 55667',
    checkInPhotoWithDriverUrl: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=800&q=80',
    checkInNotes: 'Cars24 fleet car for refurb & bumper paint.',
    status: 'JOB_CARD_CREATED',
    jobCardId: 'JC-2026-102',
  },
  {
    ...
    customerPhone: '+91 98330 67890',
    checkedInAt: '2026-07-25 10:00 AM',
    checkedInByName: 'Marcus Vance',
    checkInDriverName: 'Ananya Roy (Owner)',
    checkInDriverPhone: '+91 98330 67890',
    checkInPhotoWithDriverUrl: 'https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&w=800&q=80',
    checkInNotes: 'Periodic maintenance & AC servicing.',
